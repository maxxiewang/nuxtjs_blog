<template>
    ...
    <div class="mxg-footer">
      <div class="warp">
        ...
        <el-divider>Make a better world</el-divider>
        ...
        <div class="footer-information-box">
          <p>Copyright &copy;2020 facebook.com &nbsp;All Rights Reserved&nbsp;
            <a href="http://www.beian.miit.gov.cn/" target="_blank" rel="nofollow"> 辽ICP备16666888号-99</a> 
          </p>
        </div>
      </div>
